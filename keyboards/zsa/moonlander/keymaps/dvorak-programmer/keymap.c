...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DVORAK_DP] = LAYOUT_moonlander(
    ...
    KC_CAPS,        DP_A,           DP_O,           DP_E,           DP_U,           DP_I,           KC_BSPC,                                                                        KC_DELETE,      DP_D,           DP_H,           DP_T,           DP_N,           DP_S,           DP_BSLS,
    KC_ESCAPE,      DP_QUOT,   DP_Q,           DP_J,           DP_K,           DP_X,                                           DP_B,           DP_M,           DP_W,           DP_V,           DP_Z,           DP_MINS,
    LALT(LCTL(KC_SPACE)),KC_LEFT_SHIFT,  KC_LEFT_CTRL,   KC_LEFT_ALT,    KC_LEFT_GUI,    MAC_MISSION_CONTROL,                                                                                                TO(NAVIGATION),         KC_RIGHT_GUI,    KC_RIGHT_ALT,    KC_RIGHT_CTRL,   KC_RIGHT_SHIFT,  MAC_LOCK,
  ...
  [SPECIAL] = LAYOUT_moonlander(
    ...
    LGUI(LSFT(DP_DOT)),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, DP_0,           DF_DOT_COMMA,   KC_EQUAL,       KC_LABK,        KC_RABK,
  ...
  [NAVIGATION] = LAYOUT_moonlander(
    ...
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                                                                                          TO(DVORAK_DP),                    MACRO_LAYER_VALHEIM, TO(DVORAK_KC),          KC_NO,          KC_NO,          KC_NO,
  ...
  [VALHEIM] = LAYOUT_moonlander(
    ...
    KC_MEDIA_PREV_TRACK,KC_AUDIO_MUTE,  KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_MEDIA_NEXT_TRACK,TO(0),                                                                                                          MACRO_LAYER_DVORAK_DP,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
  ...
  [DVORAK_KC] = LAYOUT_moonlander(
    ...
    LALT(LCTL(KC_SPACE)),KC_LEFT_SHIFT,  KC_LEFT_CTRL,   KC_LEFT_ALT,    KC_LEFT_GUI,    MAC_MISSION_CONTROL,                                                                                                TO(DVORAK_DP),         KC_RIGHT_GUI,    KC_RIGHT_ALT,    KC_RIGHT_CTRL,   KC_RIGHT_SHIFT,  MAC_LOCK,
    DF_SPACE_RAYCAST,    TT(SPECIAL),          KC_HYPR,                        KC_HYPR,        TT(SPECIAL),          DF_ENTER_LGUIENTER
  )
};
